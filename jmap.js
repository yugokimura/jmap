...
(function($) {
    ...
    var conf = {
        prefectures: [
            ...
            { code: 36, name: "徳島", full: "県", alphabet: "Tokushima", area8: 7, area11: 8, cordinate: { x: 19, y: 21, z: 17 }, size: { x: 4, y: 2 }, radius: [0, 0, 1, 0] },
            { code: 37, name: "香川", full: "県", alphabet: "Kagawa", area8: 7, area11: 8, cordinate: { x: 19, y: 19, z: 16 }, size: { x: 4, y: 2 }, radius: [0, 1, 0, 0] },
            { code: 38, name: "愛媛", full: "県", alphabet: "Ehime", area8: 7, area11: 8, cordinate: { x: 15, y: 19, z: 14 }, size: { x: 4, y: 2 }, radius: [1, 0, 0, 0] },
            { code: 39, name: "高知", full: "県", alphabet: "Kochi", area8: 7, area11: 8, cordinate: { x: 15, y: 21, z: 15 }, size: { x: 4, y: 2 }, radius: [0, 0, 0, 1] },
